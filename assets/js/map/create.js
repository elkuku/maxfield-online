...
const LeafIcon = L.Icon.extend({
    options: {
        shadowUrl: '/build/images/leaf-shadow.png',
        iconSize: [38, 95],
        shadowSize: [50, 64],
        iconAnchor: [22, 94],
        shadowAnchor: [4, 62],
...
const redIcon = new LeafIcon({iconUrl: '/build/images/leaf-red.png'}),
    orangeIcon = new LeafIcon({iconUrl: '/build/images/leaf-orange.png'})
...
function loadMarkers() {
    ...
    $.get('/map/get-waypoints?bounds=' + bounds, {some_var: ''}, function (data) {
...
// const myModalEl = document.getElementById('maxfieldModal')
document.getElementById('maxfieldModal')
...
$('#selectToggle').on('click', function () {
    if ('remove' === selectionMode) {
        ...
        $(this).find('span').removeClass('bi-dash-lg')
    } else {
        selectionMode = 'remove'
        $(this).addClass('btn-outline-danger')
        $(this).removeClass('btn-outline-success')
        $(this).find('span').addClass('bi-dash-lg')
